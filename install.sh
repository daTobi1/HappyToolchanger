...
# Remove any existing symlinks first — cat > follows symlinks and would
# overwrite the source file in eddy-ng/ instead of creating a regular file.
LOADER_PROBE="${KLIPPER_EXTRAS}/probe_eddy_ng.py"
[ -L "$LOADER_PROBE" ] && rm -f "$LOADER_PROBE"
